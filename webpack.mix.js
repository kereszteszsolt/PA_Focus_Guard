...
mix.setPublicPath('./')
    ...
    .js('src/js/scripts/background/website-elements-blocker/blockFacebookElements.js', 'dist/js/scripts/background/website-elements-blocker')
    .js('src/js/scripts/background/website-elements-blocker/blockYoutubeElements.js', 'dist/js/scripts/background/website-elements-blocker')

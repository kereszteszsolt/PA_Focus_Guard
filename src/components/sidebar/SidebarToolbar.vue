...
<template>
  <v-container class="d-flex justify-space-between align-center fg-h-104px">
    <v-btn to="/websites" size="x-large" icon='mdi-home'
           v-if="path !== 'websites' && (path === 'languages' || path === 'settings')" color="accent" variant="elevated"
           elevation="12"></v-btn>
    ...
    <v-btn to="/languages" size="x-large" icon='mdi-translate' v-if="path !== 'languages'" color="accent"
           variant="elevated" elevation="12"></v-btn>
    <v-btn to="/settings" size="x-large" icon='mdi-wrench' v-if="path !== 'settings'" color="accent" variant="elevated"
           elevation="12"></v-btn>
  </v-container>
</template>
